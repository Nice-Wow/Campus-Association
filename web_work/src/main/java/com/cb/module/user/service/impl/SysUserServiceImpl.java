package com.cb.module.user.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.cb.module.common.entity.AjaxResult;
import com.cb.module.user.dao.SysUserRepository;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserRepository, SysUser> implements SysUserService {
    ...
    public AjaxResult registerUser(SysUser sysUser){
        ...
        tempCount = this.baseMapper.selectCount(new QueryWrapper<SysUser>().eq("phone_num",sysUser.getPhoneNum()));
        if(tempCount != null &&  tempCount > 0){
